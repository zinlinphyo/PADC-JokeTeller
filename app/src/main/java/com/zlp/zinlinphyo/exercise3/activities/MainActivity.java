package com.zlp.zinlinphyo.exercise3.activities;
...
import com.zlp.zinlinphyo.exercise3.R;
import com.zlp.zinlinphyo.exercise3.fragments.MainFragment;
...
//        });
    ...
    Fragment Fragdetail = new MainFragment();
    getSupportFragmentManager().beginTransaction().replace(R.id.fl_container,Fragdetail).commit();

    Button btnNext = (Button) findViewById(R.id.btn_next);
    Button btnPrevious = (Button) findViewById(R.id.btn_previous);

    btnNext(new View.OnClickListener() {
        @Override
